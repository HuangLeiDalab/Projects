...
struct Mesh {
	...
	void draw()
	{
		...
		for (size_t fn = 0; fn < triangleCount; ++fn){

			glVertex3f(vertices[triangles[fn].x].x, vertices[triangles[fn].x].y, vertices[triangles[fn].x].z);
			glVertex3f(vertices[triangles[fn].y].x, vertices[triangles[fn].y].y, vertices[triangles[fn].y].z);
			glVertex3f(vertices[triangles[fn].z].x, vertices[triangles[fn].z].y, vertices[triangles[fn].z].z);
